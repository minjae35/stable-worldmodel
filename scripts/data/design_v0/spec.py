...
# Full pinned quentinll/lewm-pusht blob. Not the 2000/297806 CLI example.
PUSHT_EXPECTED_EPISODES = 18685
PUSHT_EXPECTED_TRANSITIONS = 2_336_736

TWOROOM_ENV_ID = 'swm/TwoRoom-v1'
OGBCUBE_ENV_ID = 'swm/OGBCube-v0'
TWOROOM_MAX_EPISODE_STEPS = 100
OGBCUBE_MAX_EPISODE_STEPS = 200
TWOROOM_EXPECTED_EPISODES = 10000
TWOROOM_ACTION_DIM = 2
PUSHT_ACTION_DIM = 2
OGBCUBE_EXPECTED_EPISODES = 10000
OGBCUBE_ACTION_DIM = 5
OGBCUBE_FRONT_COLUMN = 'pixels_front_pixels'
EXPECTED_ACTION_DIMS = {
    'TwoRoom': TWOROOM_ACTION_DIM,
    'PushT': PUSHT_ACTION_DIM,
    'OGBCube': OGBCUBE_ACTION_DIM,
}
IMAGE_SHAPE = (224, 224)
